...
// This is in the accounts/ module but is needed in the fennec/ module so I
// copied it and hard-coded the deps from Constants. Not great. :(
public class BrowserContractHelpers extends BrowserContract {

  protected static Uri withSyncAndDeletedAndProfile(Uri u) {
    return u.buildUpon()
            .appendQueryParameter(PARAM_PROFILE, "default")
